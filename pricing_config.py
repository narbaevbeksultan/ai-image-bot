...
# Настройки валюты
CURRENCY_SYMBOL = '₴'  # Символ гривны
CURRENCY_NAME = 'UAH'  # Код валюты
...
def format_price(amount: float, currency: str = 'UAH') -> str:
    ...
    if currency == 'UAH':
        return f"₴{amount:.0f}"  # Без копеек для гривен
    elif currency == 'RUB':
