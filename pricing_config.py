...
GENERATION_COSTS = {
    'dall-e-3': 100,  # кредитов за генерацию
    'sdxl': 50,       # кредитов за генерацию
    'midjourney': 75, # кредитов за генерацию
    'kandinsky': 25,  # кредитов за генерацию
    'deepfloyd': 30,  # кредитов за генерацию
    'stable-diffusion': 20, # кредитов за генерацию
    'real-esrgan': 15, # кредитов за апскейл
    'gfpgan': 20,     # кредитов за восстановление лица
    'codeformer': 25, # кредитов за восстановление лица
    'video': 200      # кредитов за генерацию видео
}
